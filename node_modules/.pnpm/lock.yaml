...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      vite-plugin-dts:
        specifier: ^4.2.0
        version: 4.5.4(@types/node@22.19.19)(rollup@4.61.0)(typescript@5.9.3)(vite@5.4.21(@types/node@22.19.19))
      vitest:
        specifier: ^2.0.0
        version: 2.1.9(@types/node@22.19.19)(jsdom@26.1.0)
...
snapshots:
  ...
  '@microsoft/api-extractor-model@7.33.10(@types/node@22.19.19)':
    dependencies:
      '@microsoft/tsdoc': 0.16.0
      '@microsoft/tsdoc-config': 0.18.1
      '@rushstack/node-core-library': 5.23.3(@types/node@22.19.19)
    transitivePeerDependencies:
      - '@types/node'

  '@microsoft/api-extractor@7.58.11(@types/node@22.19.19)':
    dependencies:
      '@microsoft/api-extractor-model': 7.33.10(@types/node@22.19.19)
      '@microsoft/tsdoc': 0.16.0
      '@microsoft/tsdoc-config': 0.18.1
      '@rushstack/node-core-library': 5.23.3(@types/node@22.19.19)
      '@rushstack/rig-package': 0.7.3
      '@rushstack/terminal': 0.24.2(@types/node@22.19.19)
      '@rushstack/ts-command-line': 5.3.12(@types/node@22.19.19)
      diff: 8.0.4
      minimatch: 10.2.3
      resolve: 1.22.12
      semver: 7.7.4
  ...
  vite-plugin-dts@4.5.4(@types/node@22.19.19)(rollup@4.61.0)(typescript@5.9.3)(vite@5.4.21(@types/node@22.19.19)):
    dependencies:
      '@microsoft/api-extractor': 7.58.11(@types/node@22.19.19)
      '@rollup/pluginutils': 5.4.0(rollup@4.61.0)
      '@volar/typescript': 2.4.28
  ...
  vitest@2.1.9(@types/node@22.19.19)(jsdom@26.1.0):
    dependencies:
      '@vitest/expect': 2.1.9
      '@vitest/mocker': 2.1.9(vite@5.4.21(@types/node@22.19.19))
      '@vitest/pretty-format': 2.1.9
